        ...
        switch (v.getId()){
            ...
            case R.id.btn_save:     //保存
                ...
                quadratic.Fitting(new Point(0,0),
                        new Point(Float.valueOf(flawPercent1.getText().toString().trim()),Float.valueOf(flawValue1.getText().toString().trim())),
                        new Point(Float.valueOf(flawPercent2.getText().toString().trim()),Float.valueOf(flawValue2.getText().toString().trim())));
                bean.setValue_a(quadratic.getA());
                bean.setValue_b(quadratic.getB());
                quadratic.Fitting(
                        new Point(Float.valueOf(flawPercent2.getText().toString().trim()),Float.valueOf(flawValue2.getText().toString().trim())),
                        new Point(Float.valueOf(flawPercent3.getText().toString().trim()),Float.valueOf(flawValue3.getText().toString().trim())),
                        new Point(Float.valueOf(flawPercent4.getText().toString().trim()),Float.valueOf(flawValue4.getText().toString().trim())));
